    ...
    {        
        ...
        */
        ...
        [   
            ...
            'controller' => 'AdminDonacionesController',
            'is_protected' => 0,
            'is_active' => 0  
        ],[
            ...
            'path' => 'gastos',
            'table_name' => 'gastos',
            'controller' => 'AdminGastosController',
            'is_protected' => 0,
            'is_active' => 0   
        ],[
        
            'created_at'=>date('Y-m-d H:i:s'),
            'name' => 'Ingresos y Gastos por fechas',
            'icon' => 'fa fa-money',
            'path' => 'relacion_ingresos_gastos',
            'table_name' => 'relacion_ingresos_gastos',
            'controller' => 'AdminRelacionIngresosGastosController',
            'is_protected' => 0,
            'is_active' => 0    
        ],[
        
            'created_at'=>date('Y-m-d H:i:s'),
            'name' => 'Pagos por Mensualidades',
            'icon' => 'fa fa-money',
            'path' => 'abonos_mensualidades',
            'table_name' => 'abonos_mensualidades',
            'controller' => 'AdminAbonosMensualidadesController',
            'is_protected' => 0,
            'is_active' => 0    
        ],[
            ...
            'created_at'=>date('Y-m-d H:i:s'),
            'name' => 'Registro de mensualidades',
            'icon' => 'fa fa-money',
            'path' => 'registro_mensualidad',
            'table_name' => '',
            'controller' => 'AdminMensualidadesRegistrosController',
            'is_protected' => 0,
            'is_active' => 0    
        ]      
            ];
...
class Cms_usersSeeder extends Seeder {
    ...
    {        
        ...
        $cms_users = DB::table('cms_users')->insert(array(
            ...
            'created_at'        =>date('Y-m-d H:i:s'),
            'name'              => 'John Snow',                
            'email'             => 'miembronormal@cru.com.ve',
            'password'          => $password,
            'id_cms_privileges' => 3,                
            'status'            =>'Active'
        )); 
...
class Cms_menusSeeder extends Seeder{
    public function run(){
        ...
        for($i = 1,$dashboardSwitcher = 0 ; $i < 3; $i++, $dashboardSwitcher++){
            DB::table('cms_menus')->insert(
                array(
                    'name' => 'Balance General',
                    'type' => 'Route',
                    'path' => 'AdminBalanceControllerGetIndex',
                    'color' => 'Normal',
                    'icon' => 'fa fa-money',
                    'parent_id' => 0,
                    'is_active' => 1,
                    'is_dashboard' => $dashboardSwitcher,
                    'id_cms_privileges' => $i,
                    'sorting' => 2
                )
            );
            ...
            DB::table('cms_menus')->insert(
                array(
                    'name' => 'Donaciones',
                    'type' => 'Route',
                    'path' => 'AdminDonacionesControllerGetIndex',
                    'color' => 'Normal',
                    'icon' => 'fa fa-money',
                    'parent_id' => 0,
                    'is_active' => 1,
            ...
            DB::table('cms_menus')->insert(
                array(
                    'name' => 'Gastos',
                    'type' => 'Route',
                    'path' => 'AdminGastosControllerGetIndex',
                    'color' => 'Normal',
                    'icon' => 'fa fa-money',
                    'parent_id' => 0,
                    'is_active' => 1,
            ...
            DB::table('cms_menus')->insert(
                array(
                    'name' => 'Ingresos y Gastos por fechas',
                    'type' => 'Route',
                    'path' => 'AdminRelacionIngresosGastosControllerGetIndex',
                    'color' => 'Normal',
                    'icon' => 'fa fa-money',
                    'parent_id' => 0,
                    'is_active' => 1,
            ...
            DB::table('cms_menus')->insert(
                array(
                    'name' => 'Pagos por Mensualidad',
                    'type' => 'Route',
                    'path' => 'AdminAbonosMensualidadesControllerGetIndex',
                    'color' => 'Normal',
                    'icon' => 'fa fa-money',
                    'parent_id' => 0,
                    'is_active' => 1,
            ...
            DB::table('cms_menus')->insert(
                array(
                    'name' => 'Registro de mensualidades',
                    'type' => 'Route',
                    'path' => 'AdminMensualidadesRegistrosControllerGetIndex',
                    'color' => 'Normal',
                    'icon' => 'fa fa-money',
                    'parent_id' => 0,
                    'is_active' => 1,
